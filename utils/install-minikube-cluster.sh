...
if [ "$GPU_AVAILABLE" = true ]; then
    ...
    minikube start --mount --mount-string="/home/ubuntu/workspace/k8mount:/home/ubuntu/workspace/k8mount" --memory=max --driver=docker --container-runtime=docker --gpus=all --force --addons=nvidia-device-plugin
